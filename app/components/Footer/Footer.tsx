        ...
        <div className="max-w-5xl w-full">
          ...
          <div className="flex justify-center tracking-[.03rem] -mt-2 opacity-95">
            <img
              ...
              width={326}
              height={326}
              className="w-[300px] sm:w-[500px] sm:h-auto object-contain"
            />
          </div>
        </div>

        <div className="max-w-5xl w-full mx-auto mt-5 pt-8 border-t border-stone-900 text-xs text-stone-400 font-sans">
