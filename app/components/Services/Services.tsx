...
export default function Services() {
  return (
    <section className="relative bg-stone-950 px-9 pt-5 pb-15 space-y-15 z-10">
      {/* Section Header */}

      <h2 className="font-display text-4xl text-white/90 leading-11">
      ...
      <div className="space-y-7 flex flex-col">
        ...
        <div className="relative flex flex-col items-center mr-3.5 pr-3 pb-3">
          ...
          {/* 3. The SVG: Shifted slightly via layout coordinates to clear the frame */}
          <svg
            className="absolute -top-7.5 -right-3 w-30 h-30 text-stone-500/60 pointer-events-none"
            viewBox="0 0 100 100"
            fill="none"
    ...
    <div className="text-red-800 -mt-4.5 -translate-x-8.5">
  <svg
    ...
    aria-hidden="true"
  >
    {/* 15 broad, premium geometric slanted slabs in a wider sequence */}
    <path
      d="
